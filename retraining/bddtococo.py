...
src_val_dir = os.path.join(cfg.bdd_dir, 'jsons', 'bdd100k_labels_images_val.json')
src_train_dir = os.path.join(cfg.bdd_dir, 'jsons', 'bdd100k_labels_images_train.json')

os.makedirs(os.path.join(cfg.bdd_dir, 'labels_coco'), exist_ok=True)

dst_val_dir = os.path.join(cfg.bdd_dir, 'labels_coco', 'val.json')
dst_train_dir = os.path.join(cfg.bdd_dir, 'labels_coco', 'train.json')
