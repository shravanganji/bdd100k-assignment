...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--val-data", help="path to your validation data file")
    parser.add_argument("--image_folder", help="path to your validation data file")
    parser.add_argument(
        "--work-dir",
...
def main() -> None:
    ...
    cfg.data.test["img_prefix"]=args.image_folder
    print(cfg.data.test)
